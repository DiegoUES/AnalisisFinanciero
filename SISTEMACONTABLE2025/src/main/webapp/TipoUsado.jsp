...
<%
    ...
    // Solo ADMIN y USUARIO pueden entrar aquí
...
<html lang="es">
    ...
    <body>
        ...
        <div class="layout-wrapper">
            ...
            <nav id="sidebar" class="bg-dark text-white p-3 d-flex flex-column">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <!-- Tipo Usado: ADMIN + USUARIO (PÁGINA ACTUAL) -->
                    <li class="nav-item">
                        <a href="TipoUsado.jsp" class="nav-link active">
                ...
                <div class="main-wrapper">
                    <div class="page-wrapper">
                        <div class="content">
                            ...
                            <!--MODAL TIPO DE USADO-->
                            <div class="modal fade" id="modalTipoUsado" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">

                                        <div class="modal-header" style="background:#7FB3D5;">
                                            <h5 class="modal-title" id="tituloModal">Registrar Tipo de Usado</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>

                                        <div class="modal-body">

                                            <form id="form_tipo_usado">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="txt_anyos" class="form-label">Años</label>
                                                        <input type="number" class="form-control"
                                                               id="txt_anyos" name="txt_anyos" 
                                                               min="1"
                                                               required>
                                                    </div>
                                                    
                                                    <div class="col-md-6">
                                                        <label for="txt_porcentaje" class="form-label">Porcentaje (Entre 20% y 80%)</label>
                                                        <input type="number" class="form-control"
        ...
        <!-- JS DE LA VISTA-->
        <script src="TipoUsado.js"></script>
